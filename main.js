const translations = {
  ko: {
    ...
    miscMarketDesc: "서울 전역에 위치한 모든 전통시장의 상세 리스트를 확인하실 수 있습니다. 가나다별로 정리된 방대한 데이터를 통해 숨겨진 로컬 시장까지 모두 찾아보세요. 서울에서 수십 년의 역사를 가진 수많은 시장들이 여러분을 기다리고 있습니다. 이 목록은 위키백과의 검증된 데이터를 바탕으로 제공되며, 서울 전역의 시장 정보를 한눈에 파악하기에 최적화된 자료입니다.",
  ...
  ja: {
    ...
    guideTip2Desc: "ほとんどの市場は午前9時から午後7時まで活発に営業しています。広蔵市場や南大門市場のような場所は、夜市や食べ物通りが夜遅く（22時〜23時）まで営業していることもあるので、事前に確認することをお勧めします。",
...
const marketsData = [
  ...
  },
  {
    ...
    translations: {
      ...
      ja: { name: "永東伝統市場", description: "現代的なビルが立ち並ぶ江南（カンナム）論峴洞（ノンヒョンドン）のど真ん中に位置し, 華やかな都心と素朴な伝統市場の姿が妙に調和している場所です。昼間は周辺の居住者のための新鮮な食材市場として, 夜は周辺の会社員の会食場所として有名なグルメ通りに変身する反転の魅力があります。豚足（チョッパル）, ジョン（チヂミ）, ヌタウナギなど, 焼酎と一緒に楽しむのに最適な美味しい店が多く, 仕事帰りの活気が感じられます。江南では珍しい人間味あふれる空間であり, 最近は若者の好みに合わせたトレンディな店も続々と入店しており, 全ての世代が調和する活気に満ちた市場です。", food: "豚足(チョッパル)、ジョン料理", sights: "江南の夜景、論峴家具通り" },
  ...
  },
  {
    ...
    translations: {
      ...
      ja: { name: "馬場畜産物市場", description: "韓国最大規模であり首都圏の精肉流通の中心地で, 新鮮で高品質な韓牛（ハヌ）を最も合理的な価格で楽しむことができる畜産物特化市場です。市場の路地ごとに精肉店が立ち並び, マーブル模様が芸術的な韓牛を直接選び, 食堂ですぐに焼いて食べる楽しさは格別です。ユッケ, 韓牛焼きなどの最高級の肉料理をふんだんに楽しむことができ, お肉愛好家にとっては聖地のような場所です。屠畜直後の新鮮な肉を扱っているため, 味と鮮度の面で圧倒的であり, 最近はオンライン配送や清潔な包装サービスも整っています。清渓川（チョンゲチョン）の散歩道と隣接しており, 食事の後に軽い散歩を楽しむのにも最適な場所です。", food: "韓牛焼き、ユッケ", sights: "清渓川散歩道" },
      zh: { name: "马场畜产物市场", description: "作为韩国最大规模及首都圈肉类流通中心, 这里是能以最合理的价格购买到新鲜高品质韩牛的畜产品特化市场。市场胡同内肉铺林立, 亲自挑选大理石花纹完美的韩牛并直接在餐厅烤食的乐趣绝佳。这里可以尽情享用肉脍、烤韩牛等最高级肉类料理, 是肉食爱好者的圣地。由于经营屠宰后直接运达的新鲜肉类, 在口感和新鲜度上具有压倒性优势, 最近在线配送和整洁的包装服务也一应俱全。市场紧邻清溪川散步道, 非常适合饭后享受轻松的散步。", food: "烤韩牛、肉脍", sights: "清溪川散步道" }
    }
  },
  {
    id: "noryangjin",
    ...
    translations: {
      ...
      ja: { name: "鷺梁津水産市場", description: "100年近い歴史を誇るソウル最高の水産物卸売市場で, 現代化事業を通じて清潔な複合文化空間として生まれ変わりました。早朝ごとに開かれる活気ある競りの現場から, 旬の海産物をすぐに選んで楽しめる食堂街まで, 五感を満足させる海の躍動感があふれる場所です。刺身の盛り合わせ, キングクラブ, メウンタン（辛い魚鍋）などの新鮮な海鮮料理を合理的な価格で楽しむことができ, 内外国人の両方にとって必須の観光コースに挙げられます。漢江（ハンガン）と汝矣島（ヨイド）の夜景が見下ろせる優れた眺望を持つ食堂も多く, 特別なディナーを楽しむのにも適しています。ソウルの都心の真ん中で海の新鮮さを満喫できる最高の場所です。", food: "刺身の盛り合わせ、メウンタン、カニ料理", sights: "競りの現場、汝矣島の夜景" },
  ...
  },
  {
    ...
    translations: {
      ...
      ja: { name: "水踰市場", description: "ソウル北部・江北区（カンブクク）を代表する伝統市場で, 非常に綺麗に整備された現代的な施設と伝統市場特有の温かい人情が共存する模範的な市場です。アーケードの屋根が設置されており, 天候に関係なく快適にショッピングを楽しむことができ, 商店が一目瞭然に整理されているため見学するのに非常に便利です。トッポギ, マンドゥ（餃子）, 豚足（チョッパル）など, 市場の定番と言える食べ物の質が非常に高く, 価格も安いため, 近隣住民から根強い人気を集めています。北漢山（プカンサン）国立公園の入り口に近く, 登山前後に立ち寄って心強い食事を済ませるのにも最適で, 人々の暮らしの匂いが漂う趣のある空間です。", food: "トッポギ、マンドゥ、豚足", sights: "北漢山国立公園入口" },
      zh: { name: "水逾市场", description: "作为代表首尔北部江北区的传统市场, 水逾市场是一个整洁的现代化设施与传统市场特有的人情味并存的模范市场。市场安装了拱廊屋顶, 无论天气如何都能舒适购物, 店铺排列井然有序, 浏览起来非常方便。炒年糕、饺子、猪蹄等正宗市场美食的品质极高且价格低廉, 深受附近居民的喜爱。由于靠近北汉山国立公园入口, 非常适合在登山前后顺道吃上一顿丰盛的饭菜。这是一个洋溢着生活气息、充满温情的空间。", food: "炒年糕、饺子、猪蹄", sights: "北汉山国立公园入口" }
    }
  },
  {
    id: "yeongdeungpo",
  ...
  },
  {
    ...
    translations: {
      ...
      ja: { name: "岩寺総合市場", description: "岩寺洞（アムサドン）先史遺跡地の近くに位置する生活密着型市場で, 地域住民の生活と密接に結びついた趣のある空間です。新鮮な野菜, 果物, そして直接作った真心のこもったおかず屋が特に有名で, 主婦たちの足が絶えない場所です。市場の路地が広く清潔に管理されているため買い物が非常に便利で, トッカルビやタッカンジョンなどの人気の食べ物も素晴らしい味を誇ります。先史遺跡地を訪れた観光客にとっても良い食事場所となり, 江東区（カンドンク）特有のゆったりとした温かい町の雰囲気をそのまま感じられる平和な市場です。商人たちの親切なサービスとおまけを付けてくれる文化が今も生きている場所です。", food: "トッカルビ、タッカンジョン、おかず", sights: "岩寺洞先史遺跡地" },
