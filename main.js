const translations = {
  ko: {
    ...
    guideGwangjangTitle: "광장시장 완전 정복 가이드:<br>먹거리부터 이용 꿀팁까지",
    ...
    gameTitle: "AI 가위바위보 놀이",
    gameSubtitle: "Teachable Machine AI와 함께 놀아보세요!",
    userLabel: "나",
    aiLabel: "AI",
    ...
    gameHow4: "팁: 밝은 곳에서 손이 잘 보이게 해주세요!",
    navTransform: "추억",
    transformTitle: "AI 이미지 추억",
    transformSubtitle: "업로드한 사진을 흑백 또는 컬러로 간직하고 다운로드하세요.",
    btnUpload: "사진 업로드",
    btnToggle: "흑백/컬러 전환",
    btnDownload: "이미지 저장",
  ...
  en: {
    ...
    guideGwangjangTitle: "Mastering Gwangjang Market:<br>From Food to Tips",
    ...
    gameTitle: "AI Rock-Paper-Scissors Play",
    gameSubtitle: "Have fun with the Teachable Machine AI!",
    userLabel: "Me",
    aiLabel: "AI",
    aiChoiceLabel: "AI's Choice",
    gameStartBtn: "Start Play!",
    gameReady: "Are you ready?",
    ...
    gameHowTitle: "How to Play:",
    gameHow1: "Click 'Start Play!' to begin a 3-second countdown.",
    ...
    navTransform: "Memories",
    transformTitle: "AI Image Memories",
    transformSubtitle: "Keep your uploaded photos in grayscale or color and download them.",
  ...
  ja: {
    ...
    guideGwangjangTitle: "広蔵市場 完全攻略ガイド:<br>グルメから利用のコツまで",
    ...
    gameTitle: "AI じゃんけん遊び",
    gameSubtitle: "Teachable Machine AIと遊ぼう！",
    userLabel: "自分",
    aiLabel: "AI",
    aiChoiceLabel: "AIの選択",
    gameStartBtn: "遊び開始！",
    ...
    navTransform: "思い出",
    transformTitle: "AI画像思い出",
    transformSubtitle: "アップロードした写真を白黒やカラーで保存しましょう。",
    btnUpload: "写真アップロード",
    ...
    transformHow4: "ヒント: 高画質写真も素早く変換してダウンロードできます！",
    storiesTitle: "ソウル伝統市場の物語",
    storiesSubtitle: "数千の店舗、数万の人々。彼らが作り出す真実の人生の記録",
    storyTag1: "商人のインタビュー",
    storyTitle1: "「ピンデトッ一枚に込められた30年の歳月」",
    storyExcerpt1: "広蔵市場で30年間石臼を回し続けているパク・スンジャおばあさん。油の匂い漂うその場所で、おばあさんが守ってきたのは単なる食べ物ではなく、客との約束でした。",
    storyLink: "続きを読む &rarr;",
    storyTag2: "ローカルレポート",
    storyTitle2: "アナログとヒップ(Hip)の融合、東廟の午後",
    storyExcerpt2: "お年寄りの専売特許だった東廟フリーマーケットが、どのようにして若者のファッションの聖地になったのでしょうか？東廟の狭い路地で見つけた世代和合の現場を記録しました。",
    storyTag3: "文化体験",
    storyTitle3: "チャリンと鳴る葉銭の音に乗ってくる思い出",
    storyExcerpt3: "通仁市場の葉銭弁当は単なるマーケ팅ではありません。忘れられゆく伝統通貨の価値を子供たちに教え、大人たちには郷愁を呼び起こす架け橋の役割を果たしています。",
    storyTag4: "現場記録",
    storyTitle4: "誰よりも早く朝を迎える人々：鷺梁津の夜明け",
  ...
  zh: {
    ...
    guideGwangjangTitle: "广藏市场完全攻略指南:<br>从美食到使用小贴士",
    ...
    miscMarketDesc: "您可以查看位于首尔全境的所有传统市场的详细列表。通过按区整理的海量数据, 寻找隐藏的本地市场。从百年历史的市场到当地社区的小市场, 探索首尔多样的市场文化。此列表基于经过验证的来源提供。",
    miscMarketFood: "首尔全境的所有本地美食",
    miscMarketSights: "数百个首尔传统市场指南",
    gameTitle: "AI 猜拳活动",
    gameSubtitle: "与 Teachable Machine AI 一起玩耍吧！",
    userLabel: "我",
    aiLabel: "AI",
    aiChoiceLabel: "AI的选择",
    gameStartBtn: "开始活动！",
    ...
    storiesTitle: "首尔传统市场故事",
    storiesSubtitle: "数千家店铺，数万名人员。他们创造的真实生活记录",
    storyTag1: "商户采访",
    storyTitle1: "“一张绿豆饼中蕴含的30年岁月”",
    storyExcerpt1: "在广藏市场转了30年石磨的朴顺子奶奶。在充满油烟味的地方，奶奶守护的不仅仅是食物，更是与顾客的约定。",
    storyLink: "继续阅读 &rarr;",
    storyTag2: "当地报告",
    storyTitle2: "复古与时尚(Hip)的相遇，东庙的午后",
    storyExcerpt2: "曾是老年人专利的东庙跳蚤市场是如何成为年轻人的时尚圣地的？记录了在东庙狭窄胡同里发现의 世代和谐的现场。",
    storyTag3: "文化体验",
    storyTitle3: "随着叮当响的铜钱声传来的回忆",
    storyExcerpt3: "通仁市场的铜钱便当不仅仅是营销。它在向孩子们传授逐渐被遗忘的传统货币价值，同时也为成年人起到了唤起乡愁的桥梁作用。",
    storyTag4: "现场记录",
    storyTitle4: "最早开启黎明的人们：鹭梁津的凌晨",
    storyExcerpt4: "在万籁俱寂的凌晨2点，鹭梁津水产市场终于苏醒。记录了伴随着激烈的拍卖声，为首尔的一天做准备的人们的热情。"
  }
};
...
const marketsData = [
  ...
  },
  {
    ...
    translations: {
      ...
      ja: { name: "望遠市場", description: "最近, MZ世代や若い旅行者に最も愛されているホットプレイス市場の一つで, 洗練された感覚と伝統市場の温かみが絶妙に共存する場所です。望遠洞（マンウォンドン）の独特な雰囲기를 盛り込んだ美味しい店や, 安くて質の高い軽食が多く, SNSでも大きな話題になっています。タッカンジョン, 手作りコロッケ, カルグクスなど, 行列ができる有名な店が立ち並び, 近くのマン리단通りや望遠漢江公園を一緒に訪れるのに非常に適しています。市場内部が綺麗に整備されており, 快適にショッピングと美食の旅を楽しめるのが大きな長所です。", food: "タッカンジョン, 手作りコロッケ, カルグクス", sights: "望遠洞カフェ通り, 望遠漢江公園" },
...
function init() {
  ...
  function setLanguage(lang) {
    ...
    // Footer links
    const footerStories = document.getElementById("footer-stories");
    if (footerStories) footerStories.textContent = t.navStories;
    const footerGame = document.getElementById("footer-game");
    if (footerGame) footerGame.textContent = t.navGame;
    const footerTransform = document.getElementById("footer-transform");
    if (footerTransform) footerTransform.textContent = t.navTransform;
