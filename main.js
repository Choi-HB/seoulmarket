const translations = {
  ...
  ja: {
    ...
    guideTip1Desc: "ほとんどの市場店舗でクレジットカードやモバイル決済が可能です。しかし、小さな屋台や伝統的なおやつを買うときは、現金を準備するか、ゼロペイ(Zero Pay)を利用すると便利で特典도多いです。",
...
const marketsData = [
  ...
  },
  {
    ...
    translations: {
      ...
      ja: { name: "望遠市場", description: "最近, MZ世代や若い旅行者に最も愛されているホットプレイス市場の一つで, 洗練された感覚と伝統市場の温かみが絶妙に共存する場所です。望遠洞（マンウォンドン）の独特な雰囲気を盛り込んだ美味しい店や, 安くて質の高い軽食が多く, SNSでも大きな話題になっています。タッカンジョン, 手作りコロッケ, カルグクスなど, 行列ができる有名な店が立ち並び, 近くのマンリダン通りや望遠漢江公園を一緒に訪れるのに非常に適しています。市場 내부가 綺麗に整備されており, 快適にショッピングと美食の旅を楽しめるのが大きな長所です。", food: "タッカンジョン、手作りコロッケ、カルグクス", sights: "望遠洞カフェ通り、望遠漢江公園" },
  ...
  },
  {
    ...
    translations: {
      ...
      zh: { name: "通仁市场", description: "位于景福宫西侧西村中心的通仁市场是一个小巧而温馨的市场。这里最大的特色是“铜钱便当”咖啡馆, 游客可以购买市场内通用的“铜钱”, 然后用它们挑选自己喜欢的菜肴组成便当。拿着铜钱在市场各处走动, 挑选油炒年糕、各类煎饼、凉拌菜等小吃的乐趣, 使其深受国内外游客的喜爱。虽然规模不大, 但它与西村韩屋村幽静的氛围相得益彰, 散发着独特的魅力。这里地理位置优越, 饭后非常方便前往景福宫或青瓦台参观, 是一个可以感受怀旧情调并享受愉快用餐体验的好地方。", food: "油炒年糕、铜钱便当", sights: "景福宫、西村韩屋村" }
    }
  },
  {
    id: "gyeongdong",
  ...
  },
  {
    ...
    translations: {
      ...
      ja: { name: "鷺梁津水産市場", description: "100年近い歴史を誇るソウル最高の水産物卸売市場で, 現代化事業を通じて清潔な複合文化空間として生まれ変わりました。早朝ごとに開かれる活気ある競りの現場から, 旬の海産物をすぐに選んで楽しめる食堂街まで, 五感を満足させる海の躍動感があふれる場所です。刺身の盛り合わせ, キングクラブ, メウンタン（辛い魚鍋）などの新鮮な海鮮料理を合理的な価格で楽しむことができ, 内外国人の両方にとって必須の観光コースに挙げられます。漢江（ハンガン）と汝矣島（ヨイド）の夜景が見下ろせる優れた眺望を持つ食堂も多く, 特別なディナーを楽しむのにも適しています。ソウルの都心の真ん中で海の新鮮さを満끽できる最高の場所です。", food: "刺身の盛り合わせ、메운탕、カニ料理", sights: "競りの現場、汝矣島の夜景" },
  ...
  },
  {
    ...
    translations: {
      ...
      ja: { name: "岩寺総合市場", description: "岩寺洞（アム사ドン）先史遺跡地の近くに位置する生活密着型市場で, 地域住民の生活と密接に結びついた趣のある空間です。新鮮な野菜, 果物, そして直接作った真心のこもったおかず屋が特に有名で, 主婦たちの足が絶えない場所です。市場の路地が広く清潔に管理されているため買い物が非常に便利で, トッカル비やタッカンジョンなどの人気の食べ物も素晴らしい味を誇ります。先史遺跡地を訪れた観光客にとっても良い食事場所となり, 江東区（カンドンク）特有のゆったりとした温かい町の雰囲기를 그대로 느낄 수 있는 平和な市場です。商人たちの親切なサービスとおまけを付けてくれる文化が今も生きている場所です。", food: "トッカルビ、タッカンジョン、おかず", sights: "岩寺洞先史遺跡地" },
