...
const marketsData = [
  {
    ...
    translations: {
      ...
      ja: { name: "広蔵市場", description: "100年以上の歴史を持つ韓国初の常設市場。ピン데토ッや麻薬キンパなどの屋台料理が充実しています。", food: "ピン데토ッ、麻薬キンパ、ユッケ", sights: "韓服通り、古着市場、夜市" },
  ...
  },
  {
    ...
    translations: {
      ...
      zh: { name: "南大门市场", description: "位于崇礼门附近的韩国最大规模传统市场. 被称为“万물시장”。", food: "炖带鱼、刀切面、糖饼", sights: "崇礼门、饰品批发商街、相机街" }
    }
  },
  {
    id: "mangwon",
  ...
  },
  {
    ...
    translations: {
      ...
      zh: { name: "通仁市场", description: "位于景福宫旁的温馨小市场. 以“铜钱便当”系统闻名, 深受游客欢迎。", food: "油炒年糕、铜钱便当", sights: "景福宫、西村韓屋村" }
    }
  },
  {
    id: "gyeongdong",
    ...
    translations: {
      ...
      zh: { name: "京东市场", description: "韩国最大规模的药令市场所在地, 充满着韩药材의 향기。", food: "韩方茶、市场炸鸡", sights: "首尔药令市、韩医药博物馆" }
    }
  },
  {
    id: "garak",
  ...
  },
  {
    ...
    translations: {
      ...
      zh: { name: "首尔风物市场", description: "充满古董 and 回忆物品的跳蚤市场. 仿佛乘坐时光机回到过去。", food: "传统零食", sights: "清溪川散歩道、回忆之街" }
    }
  },
  {
    id: "yeongdong",
  ...
  },
  {
    ...
    translations: {
      ...
      ja: { name: "東大門総合市場", description: "世界的な 生地および副資材の専門市場. 韓国ファッション産業の心臓部です。", food: "タッカンマリ、焼き魚", sights: "DDP、清渓川、興仁之門" },
  ...
  },
  {
    ...
    translations: {
      ...
      zh: { name: "马场畜产物市场", description: "韩国最大规模的畜产物专业市场. 可以品尝新鲜优质的韓牛。", food: "烤韩牛、肉脍", sights: "清溪川散歩道" }
    }
  },
  {
    id: "noryangjin",
    ...
    translations: {
      ...
      ja: { name: "鷺梁津水産市場", description: "100年の歴史を持つソウル最高の水産物卸売市場. 獲れたての新鮮な魚介類を楽しめます。", food: "刺身の盛り合わせ、メ운タン、カニ料理", sights: "競りの現場、汝矣島の夜景" },
  ...
  },
  {
    ...
    translations: {
      ...
      zh: { name: "水逾市场", description: "代表首尔北部的传统市场. 可以感受到整洁의 设施和人情味。", food: "炒年糕、饺子、猪蹄", sights: "北汉山国立公園入口" }
    }
  },
  {
    id: "yeongdeungpo",
    ...
    translations: {
      ...
      ja: { name: "永登浦伝統市場", description: "ソウル南西圏で最大規模を誇る市場で, 膨大な商品群を揃えています。", food: "スン데크、モリ肉", sights: "永登浦タイムズスクエア" },
  ...
  },
  {
    ...
    translations: {
      ...
      zh: { name: "자양전통시장", description: "物价低廉、美食丰富的活力市场. 是一个智能现代化的市场。", food: "炸鸡块、麻花、刀切面", sights: "纛岛汉江公园" }
    }
  },
  {
    id: "amsa",
  ...
  },
  {
    id: "bangi",
    district: "송파구",
    image: "https://tong.visitkorea.or.kr/cms/resource/41/2654141_image2_1.jpg",
    ...
    translations: {
      ...
      ja: { name: "芳荑市場", description: "オリンピック公園近くの生活密着型市場. カフェと伝統的な老舗が調和しています。", food: "スン데크、トンカ츠、ホットク", sights: "オリンピック公園, ロッテワールドタワー" },
